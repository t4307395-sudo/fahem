...
export async function onRequestPut({ request, env, params }) {
  ...
  const subject = limitText(x.subject, 160), lesson = limitText(x.chapter || x.lesson, 160), prompt = limitText(x.prompt, 20000), unit = limitText(x.unit, 160) || 'الوحدة الأولى';
  ...
  const correct_answer = limitText(x.correct_answer, 1000) || null;
