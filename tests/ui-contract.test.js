...
describe('Textbook question bank SPA contract',()=>{
 ...
 it('requires a subject before narrowing down to lessons',()=>{expect(app).toContain('id="subject"');expect(app).toContain('state.subject');expect(app).toContain('q.subject===state.subject');});
